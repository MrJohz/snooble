...
class TestOAuth(object):
    ...
    def test_scope(self):
        auth = oauth.OAuth(oauth.SCRIPT_TYPE, scopes=['read'],
    ...
    def test_lack_of_params(self):
        with pytest.raises(TypeError):
            oauth.OAuth(oauth.SCRIPT_TYPE, scopes=['read'])

    def test_with_invalid_type(self):
        with pytest.raises(ValueError):
            oauth.OAuth('INVALID AUTH TYPE', scopes=['read'])
    ...
    def test_explicit(self):
        auth = oauth.OAuth(oauth.EXPLICIT_TYPE, scopes=['read'],
    ...
    def test_application_explicit(self):
        auth = oauth.OAuth(oauth.APPLICATION_EXPLICIT_TYPE, scopes=['read'],
            client_id='...', secret_id='...')
    ...
    def test_implicit(self):
        auth = oauth.OAuth(oauth.IMPLICIT_TYPE, scopes=['read'],
    ...
    def test_application_implicit(self):
        auth = oauth.OAuth(oauth.APPLICATION_IMPLICIT_TYPE, scopes=['read'],
            client_id='...')
